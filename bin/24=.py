...
class GameApp(App):
    def build(self):
        ...
        # 显示牌和值
        self.card_label = Label(text="等待抽牌...", font_size=20, size_hint=(1, 0.2))
        self.layout.add_widget(self.card_label)

        # 用户输入框
        self.input_box = TextInput(hint_text="输入表达式（例如 (11 + 13) * (12 - 10)）", size_hint=(1, 0.2))
        self.layout.add_widget(self.input_box)

        # 提交按钮
        self.submit_button = Button(text="提交", size_hint=(1, 0.2))
